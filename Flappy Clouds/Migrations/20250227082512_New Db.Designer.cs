...
namespace Flappy_Clouds.Migrations
{
    ...
    [Migration("20250227082512_New Db")]
    partial class NewDb
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Flappy_Clouds.Models.Category", b =>
                {
            ...
            modelBuilder.Entity("Flappy_Clouds.Models.Order", b =>
                {
            ...
            modelBuilder.Entity("Flappy_Clouds.Models.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("Flappy_Clouds.Models.Product", b =>
                {
                    b.Property<int>("ProductId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Flappy_Clouds.Models.Review", b =>
                {
            ...
            modelBuilder.Entity("Flappy_Clouds.Models.ShoppingCart", b =>
                {
            ...
            modelBuilder.Entity("Flappy_Clouds.Models.Subscriber", b =>
                {
            ...
            modelBuilder.Entity("Flappy_Clouds.Models.User", b =>
                {
                    b.Property<int>("UserId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Flappy_Clouds.Models.Order", b =>
                {
                    b.HasOne("Flappy_Clouds.Models.User", "User")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("Flappy_Clouds.Models.OrderDetail", b =>
                {
                    b.HasOne("Flappy_Clouds.Models.Order", "Order")
                    ...
                    b.HasOne("Flappy_Clouds.Models.Product", "Product")
                        .WithMany("OrderDetails")
            ...
            modelBuilder.Entity("Flappy_Clouds.Models.Product", b =>
                {
                    b.HasOne("Flappy_Clouds.Models.Category", "Category")
                        .WithMany("Products")
